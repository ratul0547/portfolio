                ...
                <ul className="flex flex-wrap gap-2">
                  {item.skillsDemonstrated.map((skill) => (
                    <li
                      ...
                      className={`badge ${getSkillBadgeClass(skill)} badge-soft badge-theme-text badge-sm rounded-full font-normal transition-[opacity,transform] hover:opacity-90 hover:-translate-y-px`}
                    >
                      {skill}
                    </li>
                  ))}
